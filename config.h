...
static const char *fonts[]          = { "TakaoGothic:size=10" };
...
static const char *const autostart[] = {
  ...
  "nm-applet", NULL,
  "dunst", NULL,
  "sh", "-c", "st -c neomutt neomutt", NULL,
...
static const Rule rules[] = {
  ...
  { "tabbed",      NULL,           NULL,    1 << 1,       0,          0,         0,    -1 },
  { "discord",     NULL,           NULL,    1 << 4,       0,          0,         0,    -1 },
  { "neomutt",     NULL,           NULL,    1 << 4,       0,          0,         0,    -1 },
...
static const Layout layouts[] = {
  ...
  { "[\\]",	dwindle },		/* Default: Decreasing in size right and leftward */
...
static Key keys[] = {
  ...
  { MODKEY,             XK_Return, spawn,          SHCMD("emacs")  },
